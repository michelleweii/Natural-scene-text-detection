...
# 产生的文件路径和名字
generate_txt = '../sample/icdar2013_annotations_test_set.txt'
...
def generate(dirs_):
    ...
    for dir_ in dirs_:
        ...
        label_dir_full = dir_ + '/Challenge2_Test_Task1_GT/'  # 标注文件夹
        img_dir_full = dir_ + '/Challenge2_Test_Task12_Images/'  # 图片文件夹
