...
def main():
    ...
    TRAIN_ANNOTATIONS_FILE = '../sample/icdar2013_annotations_train_syn_set.txt'
    TRAIN_SAVE_PICKLE_FILE = '../sample/icdar2013_train_syn_sample.pkl'
...
if __name__ == '__main__':
    ...
    GroundTruthPath_train = '../result/' + CNNModel + '/ground-truth-train-syn/'
